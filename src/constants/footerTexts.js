...
export const CODE_OF_CONDUCT = (
    <>
        ...
        <p>All participants of CUSEC are expected to abide by our Code of Conduct, both online and during in-person events that are hosted and/or associated with CUSEC.</p>

        <br/>

        <h2 className="font-bold">The Pledge</h2>
        <p>In the interest of fostering an open and welcoming environment, we pledge to make participation in our project and our community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual identity and orientation.</p>

        <br/>

        <h2 className="font-bold">The Standards</h2>
        ...
        <ul className="list-disc list-inside">
            ...
            <li>The usage of sexualized language or imagery and unwelcome sexual attention or advances.</li>
